...
getScore <- function() {
  ...
  while (done != 1) {
    ...
    if (tag == 1) 
    {
      ...
      SampleSpacers = AllSpacers[[task$SampleNumber * 2 - 1]]
      SampleSpacersQuantity = AllSpacers[[task$SampleNumber * 2]]
      OtherSampleSpacers = AllSpacers[[task$OtherSampleNumber * 2 - 1]]
      OtherSampleSpacersQuantity = AllSpacers[[task$OtherSampleNumber * 2]]
